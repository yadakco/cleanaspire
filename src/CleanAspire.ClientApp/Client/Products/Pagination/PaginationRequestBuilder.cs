...
using System;
namespace CleanAspire.Api.Client.Products.Pagination
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::CleanAspire.Api.Client.Products.Pagination.PaginationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::CleanAspire.Api.Client.Models.ProductsWithPaginationQuery body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::CleanAspire.Api.Client.Models.ProductsWithPaginationQuery body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::CleanAspire.Api.Client.Products.Pagination.PaginationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::CleanAspire.Api.Client.Products.Pagination.PaginationRequestBuilder WithUrl(string rawUrl)
        {
            return new global::CleanAspire.Api.Client.Products.Pagination.PaginationRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
