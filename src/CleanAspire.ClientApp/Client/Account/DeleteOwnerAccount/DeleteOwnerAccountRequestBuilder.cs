...
#nullable enable
        public async Task<Stream?> DeleteAsync(global::CleanAspire.Api.Client.Models.DeleteUserRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> DeleteAsync(global::CleanAspire.Api.Client.Models.DeleteUserRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
