...
using System;
namespace CleanAspire.Api.Client.Account.Google.SignIn
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder.SignInRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder.SignInRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SignInRequestBuilderPostRequestConfiguration : RequestConfiguration<global::CleanAspire.Api.Client.Account.Google.SignIn.SignInRequestBuilder.SignInRequestBuilderPostQueryParameters>
        {
        }
    }
}
